...
#define GT_MIDI_H
//
//		Basic MIDI-File implementation
//		
//		Parses a MIDI file into memory.
//		Was used to play `synth.h`, but I'm just gonna
//		use it to convert midi files to my own data-block format.
...
typedef struct MIDI_File {
	Uint32 uspq;		// Microseconds per quarter-note
	MIDI_Header header;
	MIDI_Track *tracks;
} MIDI_File;
...
//	Prints out all the info in a MIDI file
//	
